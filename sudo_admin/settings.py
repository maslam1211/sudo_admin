...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'admin_app/templates'),  # Add this line for the correct template path
        ],
        'APP_DIRS': True,  # Ensures Django looks for templates inside your app folders
        'OPTIONS': {
            'context_processors': [
...
TWILIO_AUTH_TOKEN = '27630a3a5edbe5d2421600ccc609bbdc'    # Get from Twilio console
