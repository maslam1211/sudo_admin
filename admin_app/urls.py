...
urlpatterns = [
    ...
    path('login/otp/send/', views.admin_login_otp_send, name='admin_login_otp_send'),
    path('login/otp/resend/', views.admin_login_otp_resend, name='admin_login_otp_resend'),
    path('login/otp/verify/', views.admin_login_otp_verify, name='admin_login_otp_verify'),
    path('register-admin/', views.register_admin, name='register_admin'),
    path('dashboard/', views.dashboard, name='dashboard'),
    path('generate-qr/', views.generate_qr, name='generate_qr'),
    path('generate-qr/otp/send/', views.generate_qr_otp_send, name='generate_qr_otp_send'),
    path('generate-qr/otp/resend/', views.generate_qr_otp_resend, name='generate_qr_otp_resend'),
    path('generate-qr/otp/verify/', views.generate_qr_otp_verify, name='generate_qr_otp_verify'),
